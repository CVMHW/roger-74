    ...
    <header className="relative bg-gradient-to-r from-white to-blue-50/40 shadow-sm border-b border-blue-100/30 py-2 overflow-hidden">
      ...
      <div className="container mx-auto px-6 relative z-10">
        <div className="flex items-center justify-between">
          ...
          {/* Center Title Section - Better alignment */}
          <div className="text-center flex-1 px-6">
            <h1 className="text-xl font-bold bg-gradient-to-r from-cvmhw-blue via-cvmhw-purple to-cvmhw-blue bg-clip-text text-transparent mb-1.5 tracking-tight text-center">
            ...
            <div className="flex items-center justify-center">
              <div className="bg-white/80 rounded-lg px-4 py-2 shadow-sm border border-blue-100/40 backdrop-blur-sm">
                <div className="flex items-center gap-3 justify-center">
                  ...
                  <p className="text-xs font-medium text-slate-700 text-center">Comprehensive Mental Health Services Ages 4+ specializing in Family Psychotherapy, PTSD Treatment, Veteran's Issues, and Boy's and Men's Issues</p>
                </div>
              </div>
            </div>
          </div>
