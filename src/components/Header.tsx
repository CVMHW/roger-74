        ...
        <div className="flex items-center justify-between">
          ...
          <div className="flex items-center space-x-3">
            <div className="relative">
              <div className="h-12 w-12 bg-white rounded-xl shadow-md border border-blue-100/50 flex items-center justify-center">
                <img 
          ...
          {/* Center Title Section - More compact */}
          ...
          <div className="flex items-center space-x-3">
            ...
            <div className="relative">
              <ExternalCrisisLink variant="header" className="bg-gradient-to-r from-cvmhw-blue to-blue-600 hover:from-blue-600 hover:to-cvmhw-blue text-white border-0 shadow-lg hover:shadow-xl transition-all duration-300 px-3 py-2 text-xs font-semibold rounded-lg backdrop-blur-sm" />
            </div>
            
            {/* Roger Profile Section - More compact */}
