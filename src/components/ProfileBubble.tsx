          ...
          <div className="bg-cvmhw-blue p-2 sm:p-3 lg:p-6 rounded-t-xl relative overflow-hidden">
            ...
            <div className="flex items-start justify-between relative z-10 gap-2">
              <div className="flex items-start gap-2 sm:gap-3 lg:gap-4 flex-1 min-w-0">
                <div className="relative w-6 h-6 sm:w-12 sm:h-12 lg:w-16 lg:h-16 flex-shrink-0 mt-1">
                  <a 
                ...
                <div className="flex-1 min-w-0">
                  ...
                  <p className="text-white/90 text-xs sm:text-sm drop-shadow-md leading-tight pr-12 sm:pr-0">Peer Support Specialist at Cuyahoga Valley Mindful Health and Wellness</p>
                </div>
              </div>
            </div>
          </div>
