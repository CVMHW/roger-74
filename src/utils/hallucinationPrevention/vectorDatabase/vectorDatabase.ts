...
export class VectorDatabase {
  ...
  /**
   * Search across the default collection
   */
  public async search(vector: number[], options: any = {}): Promise<any[]> {
  ...
  /**
   * Keyword search across the default collection
   */
  public async keywordSearch(keywords: string[], options: any = {}): Promise<any[]> {
   ...
   */
  public async add(record: any): Promise<void> {
    const defaultCollection = this.collection('default');
